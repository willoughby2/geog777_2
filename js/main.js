...
var summitsPopup = L.popup({ closeButton: false });
romoSummitsLayer.on('featureClicked', featureEvent => {summitsPopup.setLatLng(featureEvent.latlng);
    let name = featureEvent.data.feature_na;
    summitsPopup.setContent('<h2>${name}</h2>');
